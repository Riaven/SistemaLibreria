...
from apps.producto.views import index, producto_view, producto_list, producto_edit, producto_delete, producto_stock
...
urlpatterns = [
    ...
    url(r'^stock/', login_required(producto_stock), name='producto_stock' )
]